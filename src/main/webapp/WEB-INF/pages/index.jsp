...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/static/assets/materialize/css/materialize.min.css" media="screen,projection" />
    <!-- Bootstrap Styles-->
    ...
    <nav class="navbar-default navbar-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav" id="main-menu">
                ...
                <li>
                    <a class="active-menu waves-effect waves-dark" href="index.jsp"><i class="fa fa-dashboard"></i>班级管理</a>
                </li>
                <li>
                    <a href="#" class="waves-effect waves-dark"><i class="fa fa-desktop"></i>今日到访</a>
                </li>
                <li>
                    <a href="#" class="waves-effect waves-dark"><i class="fa fa-bar-chart-o"></i>拨打电话</a>
                </li>
                <li>
                    <a href="" class="waves-effect waves-dark"><i class="fa fa-qrcode"></i>产品管理</a>
                </li>

                <li>
                    <a href="#" class="waves-effect waves-dark"><i class="fa fa-table"></i>特色存款</a>
                </li>
                <li>
                    <a href="#" class="waves-effect waves-dark"><i class="fa fa-edit"></i>大额存单</a>
                </li>

                <li>
                    <a href="#" class="waves-effect waves-dark"><i class="fa fa-sitemap"></i>百合理财<span class="fa arrow"></span></a>
                ...
                <li>
                    <a href="#" class="waves-effect waves-dark"><i class="fa fa-fw fa-file"></i> Empty Page</a>
                </li>
            </ul>
